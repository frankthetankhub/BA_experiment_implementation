...
queue="cv.q"
ARGS="--dataset mnist --arch_type fc1 --end_iter 250 --prune_iterations 24 --prune_percent 20 --trial_iterations 1 --patience 14 --arch_size mnist_large"
